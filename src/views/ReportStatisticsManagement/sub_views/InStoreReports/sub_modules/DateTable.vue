  ...
  <div class="layout-table" v-loading="tableModel.vLoading" element-loading-text="数据加载中">
    ...
    <div class="table-container">
      <ElTable height="100%" scrollbar-always-on :data="tableModel.data">
        ...
        ></ElTableColumn>
        <ElTableColumn label="入库参考价总金额(元)" prop="money" min-width="200" align="center" show-overflow-tooltip>
...
import { apiInventoryInDateStatisticsList } from "@/api/warehouse";
...
const onTableRequest = async () => {
  ...
  const { success, data, message } = await apiInventoryInDateStatisticsList(tableModel.query);
  if (success) {
