  ...
  <div class="layout-table" v-loading="tableModel.vLoading" element-loading-text="数据加载中">
    <div class="query-container">
      <div class="query-left">
        <ElForm ref="formRef" :model="tableModel.query">
          ...
          <IPlatformOrgFilter></IPlatformOrgFilter><ElFormItem label="供应商" prop="supplier_name">
            <ElInput
    ...
    <div class="table-container">
      <ElTable height="100%" scrollbar-always-on :data="tableModel.data">
        ...
        <ElTableColumn label="出库结算价总金额(元)" prop="guide_price" min-width="200" align="center" show-overflow-tooltip>
          <template #default="scope">
...
import { apiInventoryOutSupplierStatisticsList } from "@/api/warehouse";
...
const onTableRequest = async () => {
  ...
  const { success, data, message } = await apiInventoryOutSupplierStatisticsList(tableModel.query);
  if (success) {
