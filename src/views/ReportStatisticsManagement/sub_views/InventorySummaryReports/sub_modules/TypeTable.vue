    ...
    <div class="table-container">
      <ElTable height="100%" scrollbar-always-on :data="tableModel.data">
        ...
        <ElTableColumn label="期初库存" prop="期初库存" align="center">
          <ElTableColumn label="数量" prop="old_count" min-width="150" align="center" show-overflow-tooltip>
          </ElTableColumn>
          ...
          <ElTableColumn label="结算价格(元)" prop="guide_price" min-width="150" align="center" show-overflow-tooltip>
            <template #default="scope"> {{ _utils.FtoY(scope.row.old_guide_price) }} </template>
          </ElTableColumn>
        </ElTableColumn>
        <ElTableColumn label="本期入库" prop="本期入库" align="center">
          <ElTableColumn label="数量" prop="in_count" min-width="150" align="center" show-overflow-tooltip>
          </ElTableColumn>
        ...
        <ElTableColumn label="本期出库" prop="本期出库" align="center">
          <ElTableColumn label="数量" prop="out_count" min-width="150" align="center" show-overflow-tooltip>
          </ElTableColumn>
        ...
        <ElTableColumn label="期末库存" prop="期末库存" align="center">
          <ElTableColumn label="数量" prop="count" min-width="150" align="center" show-overflow-tooltip>
          </ElTableColumn>
...
import { apiStocktakeTypeStatisticsList } from "@/api/warehouse";
...
const onTableRequest = async () => {
  ...
  const { success, data, message } = await apiStocktakeTypeStatisticsList(query);
  if (success) {
