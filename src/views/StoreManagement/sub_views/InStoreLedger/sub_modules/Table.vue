    ...
    <div class="table-container">
      <ElTable height="100%" scrollbar-always-on :data="tableModel.data">
        ...
        <ElTableColumn
          ...
          show-overflow-tooltip
        ></ElTableColumn>
        <ElTableColumn label="入库类型" prop="_actionType" min-width="150" align="center" show-overflow-tooltip>
        </ElTableColumn>
        <ElTableColumn label="入库数量" prop="count" min-width="130" align="center" show-overflow-tooltip>
          <template #default="scope">
...
import { InTypeObject } from "@/views/StoreManagement/aux_modules/const";
import _utils from "@/utils/index";
import { apiInventoryInOutList, apiInventoryLedgerExport } from "@/api/warehouse";

const formRef = ref();
const InStoreType = 1; // 入库
